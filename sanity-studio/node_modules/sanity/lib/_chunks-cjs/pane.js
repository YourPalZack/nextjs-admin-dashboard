...
const DocumentPaneWithLegacyTimelineStore = (props) => {
  ...
  const store = sanity.useTimelineStore(t1), onOlderRevision = sanity.useTimelineSelector(store, _temp$5), revTime = sanity.useTimelineSelector(store, _temp2$1), sinceAttributes = sanity.useTimelineSelector(store, _temp3$1), timelineDisplayed = sanity.useTimelineSelector(store, _temp4$1), timelineReady = sanity.useTimelineSelector(store, _temp5$1), isPristine = sanity.useTimelineSelector(store, _temp6), lastNonDeletedRevId = sanity.useTimelineSelector(store, _temp7);
  let t2;
